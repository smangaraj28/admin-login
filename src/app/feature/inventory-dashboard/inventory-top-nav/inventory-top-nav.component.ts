...
@Component({
  selector: 'app-inventory-top-nav',
  templateUrl: './inventory-top-nav.component.html',
  styleUrls: ['./inventory-top-nav.component.scss']
})
export class InventoryTopNavComponent implements OnInit {
