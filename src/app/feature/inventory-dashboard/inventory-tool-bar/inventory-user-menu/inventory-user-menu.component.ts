...
@Component({
  selector: 'app-inventory-user-menu',
  templateUrl: './inventory-user-menu.component.html',
  styleUrls: ['./inventory-user-menu.component.scss']
})
export class InventoryUserMenuComponent implements OnInit {
  isOpen = false;
